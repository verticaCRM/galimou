<footer class="theme-background1-dk">
<div class='container'>
...
<div class="row copyright">
	<div class="col-12">
		<p class="pull-left">
			<small>Copyright © <?php echo date('Y'),' ',bloginfo('name');?>. All rights reserved.</small>
		</p>
		<p class="pull-right">
		</p>
	</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="registerForm">
					...
					<div class="form-group">
						<div class="col-lg-offset-2 col-lg-8" id="buttonHere"> 
						</div>
					</div>
