...
<div class="portfolio_group">
	...
	<div id="business_container" class="" style="width: 90%; margin: auto;">
...
$html .= "<p style='font-size:1.3em;margin-top:4% !important;'>".__("",'bbcrm').$searchlisting->c_currency_id.number_format($searchlisting->c_listing_askingprice_c).'</p>';
...
if(!$thumbnail->fileName){
                        $html .= '<a href="/listing/'.sanitize_title($searchlisting->c_name_generic_c).'" class="listing_link" data-id="'.$searchlisting->id.'"><div class="camera">'.file_get_contents(plugin_dir_url(__DIR__)."images/camera.svg").'</div></a>';
                }else{
