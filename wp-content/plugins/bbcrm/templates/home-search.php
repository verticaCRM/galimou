...
<div style="width: 90%; margin: auto;"><!--containing both parts of the search-->
...
<div class="theme-background1-lt theme-border1-dk theme-color1-dk searchbox" style="padding:18px; margin-bottom: 18px;" id="pagewidget">
	<form method="get" action="<?php echo get_permalink($bbcrm_option["bbcrm_loginbar_searchresults"]);?>" >
		<div style="display:inline-block;vertical-align:top;margin-right:12px;">
			<label class="" for="c_listing_region_c"><?php _e("By State",'bbcrm')?></label>
			<br>
			<select style="background-color:#ffffff;" name="c_listing_town_c" id="c_listing_town_c"><option value=''>Please select</option>
				<?php
				global $bbcrm_option;
		...
		default:
			break;
				...
				?>
		<div style="display:inline-block;vertical-align:top;margin-right:12px;">
			<label class="" for="c_listing_city_c"><?php _e("By County",'bbcrm')?></label>
			<br>
			<select style="background-color:#ffffff;" name="c_listing_city_c" id="c_listing_city_c" style="min-width:200px;"><option value=''><? _e('Please select','bbcrm');?></option></select>
		</div>
		<div style="display:inline-block;vertical-align:top;margin-right:12px;">
			<label class="" for="businesscategories"><?php _e('By Category','bbcrm');?></label>
			<br>
			<select style="background-color:#ffffff;" name="c_businesscategories" id="businesscategories"><option value=''><? _e('Choose one','bbcrm');?></option>
					<?php
...
?>
		...
		<div id="advanced" style="display:none;">
			<div style="display:inline-block;vertical-align:top;margin-right:12px;">
				<label class="" style="width:140px;" for="c_ownerscashflow"><?php _e("Owner's Cash Flow:",'bbcrm')?></label>
				<br>
				<select style="background-color:#ffffff;" name="c_ownerscashflow" id="c_ownerscashflow">
			...
			<div style="display:inline-block;vertical-align:top;margin-right:12px;">
				<label class="" style="width:140px;" for="askprice"><?php _e("Asking Price:",'bbcrm')?></label>
				<br>
				<select style="background-color:#ffffff;" name="c_listing_askingprice_c" id="askprice">
					<option value=""><?php _E("Choose one",'bbcrm');?></option>
					<option value="5000|100001">0 - 100,000</option>
					<option value="100000|300001">100,000 - 300,000</option>
					<option value="300000|500001">300,000 - 500,000</option>
			...
			<div style="display:inline-block;vertical-align:top;margin-right:12px;">
				<label class="" for="generic"><?php _e('Keyword or ID:','bbcrm');?></label>
				<br>
				<input name="c_name_generic_c" class="" type="search" id="generic">
			</div>
			<div style="display:inline-block;vertical-align:top;margin-right:12px;">
				<label class="" style="width:140px;" for="downpayment"><?php _e("Deposit:",'bbcrm')?></label>
				<br>
				<select style="background-color:#ffffff;" name="c_listing_downpayment_c" id="downpayment">
					<option value=""><?php _E("Choose one",'bbcrm');?></option>
					<option value="5000|100001">0 - 100,000</option>
					<option value="100000|300001">100,000 - 300,000</option>
					<option value="300000|500001">300,000 - 500,000</option>
...
//		console.log(response)
		...
		<div id="sebu">
			<input type=submit value="<? _e('Search','bbcrm');?>" class="theme-background2-dk" />
		</div>
	</form>
</div>
</div><!--containing both parts of the search-->
