...
<section id="content" class="container" style="margin-top:20px">
	<div class="portfolio_group" id='divA'>
								...
								<div class="row">
									...
									?>
										<div class="theme-color1-dk" style="display:block;margin-top:7px;" > 
											<i class="fa fa-phone-square"></i> &nbsp;<?php _e('','bbcrm');?> <?php echo $phone_office; ?><br>
											<a href="mailto:<?php echo $broker_email; ?>"><i style="padding-right:7px;" class="fa fa-envelope-o"></i> Email</a> </br>
										</div>
									</div>
									<div  class="" style="width: 80%; margin-left: 2%; display:inline-block;float:left; clear:none;" >
										<h3><?php echo $broker->name; ?></h3>
										<?php if (!empty($broker_position)){  ?>
											<p><span class="badge outline radius blue"> <?php _e('','bbcrm');?> <?php echo $broker_position; ?><br></span></p>
										<?php } ?>
